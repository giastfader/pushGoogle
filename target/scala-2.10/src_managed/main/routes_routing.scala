...
// @LINE:8
private[this] lazy val controllers_Application_sendMessage1 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("sendMessage"))))
...
// @LINE:8
case controllers_Application_sendMessage1(params) => {
   call { 
        invokeHandler(controllers.Application.sendMessage(), HandlerDef(this, "controllers.Application", "sendMessage", Nil,"POST", """""", Routes.prefix + """sendMessage"""))
   }
}
